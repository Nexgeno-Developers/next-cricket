...
!function ($) {
		...
		BootstrapTable.DEFAULTS = {
			...
			responseHandler: function (res) {total = parseInt(res['total']);  return res;},
			...
			pageList: [10, 25, 50, 100, 250, 500, 1000, 1500],
	...
	*/
		...
		BootstrapTable.prototype.initPagination = function () {
			...
			var pageNumber = [
				...
				/* start shahid */
				var index = pageList.indexOf(pretotpage);
				if (index > -1) {
						pageList.splice(index, 1);
				}
				pretotpage = this.options.totalRows;
				pageList.push(this.options.totalRows);
				jQuery.unique(pageList);
