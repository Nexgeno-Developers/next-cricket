                ...
                <div class="tab-content bg_grey">
                    ...
                    <div id="demo-stk-lft-tab-3" class="tab-pane fade">
                        <div class="panel">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('about_us');?></h3>
                            </div>
                            <?php                                echo form_open(base_url() . 'index.php/admin/general_settings/about_us/', array(                                    'class' => 'form-horizontal',                                    'method' => 'post',                                    'id' => '',                                    'enctype' => 'multipart/form-data'                                ));                            ?>
                            <div class="panel-body"> <textarea class="summernotes" data-height='700'
                                    data-name='about_us'><?php echo $about_us; ?></textarea>
                                <!--===================================================-->
                                <!-- End Summernote -->
                            </div>
                            <div class="panel-footer text-right"> <span
                                    class="btn btn-success btn-labeled fa fa-check submitter"
                                    data-ing='<?php echo translate('saving'); ?>'
                                    data-msg='<?php echo translate('settings_updated!'); ?>'>
                                    <?php echo translate('save');?> </span> </div>
                            </form>
                        </div>
                    </div>
                </div>
