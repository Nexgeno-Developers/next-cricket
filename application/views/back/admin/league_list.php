    ...
    <table id="demo-table" class="table table-striped" data-pagination="true" data-show-refresh="true"
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="<?= base_url(); ?>index.php/admin/auction/set_league/<?= $row['league_id']; ?>"
                        class="btn btn-info btn-xs btn-labeled fa fa-money" data-toggle="tooltip"
                        data-original-title="Edit" data-container="body">Start Auction</a>

                    <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip"
                        onclick="ajax_modal('edit','Edit League','<?php echo translate('successfully_edited!'); ?>','league_edit','<?php echo $row['league_id']; ?>')"
                        data-original-title="Edit" data-container="body"><?php echo translate('edit');?></a>

                    <a onclick="delete_confirm('<?php echo $row['league_id']; ?>','<?php echo translate('really_want_to_delete_this?'); ?>')"
                        class="btn btn-danger btn-xs btn-labeled fa fa-trash" data-toggle="tooltip"
                        data-original-title="Delete" data-container="body"> <?php echo translate('delete');?></a>
                </td>
            </tr>
            <?php
			}
